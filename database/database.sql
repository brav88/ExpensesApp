...
INSERT INTO expenses (idUser, description, amount, creationDate) VALUES (1, 'Playstation 5', 600, CURDATE());
INSERT INTO ExpensesDatabase.expenses (idUser, description, amount, creationDate) VALUES (1, 'Ipad Pro', 300, CURDATE());
...
UPDATE expenses SET description = 'Apple Watch Series 7', amount = 400 WHERE id = 1;
